        ...
        parse(text) {
            ...
            for(let i = 0, l = lines.length; i < l; i++){
                ...
                if (lineFirstChar === "v") {
                    ...
                    for(let j1 = 1, jl1 = faceVertices.length - 1; j1 < jl1; j1++){
                        const v2 = faceVertices[j1];
            ...
            if (hasPrimitives === true) for(let i1 = 0, l2 = state.objects.length; i1 < l2; i1++){
...
//# sourceMappingURL=GameScene.1c1950aa.js.map
